...
namespace ProjectSplitter;

/// <summary>Splits a fixed-structure source project into per-root-folder projects and updates references.</summary>
public sealed class ProjectSplitterCli
{
